...
<div class="bottom">
  ...
  <hr>
<form action="mcqinsert.php" method="POST" class="box">
	...
	<input type="text" size="100" name="txtquestion" placeholder="Enter the MCQ Question.."><br>
	<input type="text" size="100" name="txtanswer1" placeholder="Enter the prefered option 1"><br>
	<input type="text" size="100" name="txtanswer2" placeholder="Enter the prefered option 2"><br>
	<input type="text" size="100" name="txtanswer3" placeholder="Enter the prefered option 3"><br>
	<input type="text" size="100" name="txtanswer4" placeholder="Enter the prefered option 4"><br>
	<div class="buttons">
